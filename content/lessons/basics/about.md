...
<a href="https://flutter.io/">Flutter</a> is a mobile <abbr title="Software Development Kit">SDK</abbr> that, at its core, is about empowering everyone to build beautiful mobile apps. Whether you come from the world of web development or native mobile development, Flutter makes it easier to create mobile apps in a familiar, simplified way, without ever giving up control to the framework.

As of this writing, Google AdWords and Alibaba are both using Flutter in production. <a href="https://flutter.io/showcase">You can see more examples of who’s using Flutter</a> (including the app I’ve worked on) on Flutter’s website on the showcase page.
